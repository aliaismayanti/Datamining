                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pull-right">
                                <a class="btn btn-warning" href="../dataset"><i class="ti-angle-left"></i><h8> &nbspKembali</h8></a>
                                            ...
                                            <?php
                                                for ($i=1; $i<=$_POST['count_add']; $i++) { ?>
                                                    <tr>
                                                        <td><?=$i ?> </td>
                                                        <td>
                                                            <input type="number" name="nim<?=$i?>" class="form-control" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="nama_mahasiswa<?=$i?>" class="form-control" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="nilai_ipk<?=$i?>" class="form-control" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="kompensasi<?=$i?>" class="form-control" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="class<?=$i?>" class="form-control" required>
                                                        </td>
                                                    </tr>         
                                            <?php           
                                                }
