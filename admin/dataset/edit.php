                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="proses.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" id="nim" name="nim" placeholder="Masukkan NIM" value="<?php echo $data['nim']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="nilai_ipk" name="nilai_ipk" placeholder="Masukkan Nilai IPK" value="<?php echo $data['nilai_ipk']; ?>" required>
                                                </div>
                                                <div class="form-group">
