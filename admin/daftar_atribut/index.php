                        ...
                        <nav>
                            <ul class="metismenu" id="menu">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="collapse">
                                        <li class="active"><a href="../daftar_atribut">Daftar Atribut</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php
                                include('../../connection.php');
                            ?>
                            <h4 class="header-title">Daftar Atribut &nbsp;</h4>
                            <br>
                            ...
                            <div class="table-responsive">
                              <table class="table table-striped text-center"> 
                                    ...
                                    <tbody>
                                        <?php
                                            $sql_atribut = mysqli_query($connection, "SELECT * FROM atribut") or die (mysqli_error($connection));
                                                if(mysqli_num_rows($sql_atribut) > 0) { 
                                                    while($data = mysqli_fetch_array($sql_atribut)) { 
                                        ?>
                                        <tr>
                                            <td><?php echo $data['id_atribut'];?></td>
